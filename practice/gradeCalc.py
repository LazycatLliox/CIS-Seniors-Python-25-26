...
overallAvg = (0.5 * examAvg) + (0.4 * progAvg) + (0.1 * assignAvg)

print(f"\nStudent's overall exam average is: {examAvg:.2f}%")
print(f"\nStudent's overall programming programing average is: {progAvg:.2f}%")
print(f"\nStudent's overall assignment average is: {assignAvg:.2f}%")
print(f"\nStudent's overall average is: {overallAvg:.2f}%")
